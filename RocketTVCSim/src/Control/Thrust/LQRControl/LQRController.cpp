...
Matrix<double, -1, 1> LQRController::computeOptimalControl(Matrix<double, -1, 1> state, Matrix<double, -1, 1> desired_state, double numIterations) {
    Matrix<double, -1, 1> error = desired_state - state;
    return K * error;
 //   list<Matrix<double, -1, 1>> u;
